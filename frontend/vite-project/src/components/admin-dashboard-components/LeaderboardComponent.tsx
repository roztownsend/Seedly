...
function LeaderBoardComponent({ topPlants }: LeaderboardProps) {
  return (
    <>
      <div className="w-full p-3 mt-10 mb-10 max-w-[800px] min-h-[250px] bg-white/90 backdrop-blur-sm rounded-3xl  shadow-2xl hover:shadow-3xl transition-all duration-500 cursor-pointer group border-2 border-transparent">
